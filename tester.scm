...
(newline)
(test "Tests/4/test1.java" 15)
(test "Tests/4/test2.java" 12)
(test "Tests/4/test3.java" 125)
(test "Tests/4/test4.java" 36)
(test "Tests/4/test5.java" 54)
(test "Tests/4/test6.java" 110)
(test "Tests/4/test7.java" 26)
(test "Tests/4/test8.java" 117)
(test "Tests/4/test9.java" 32)
(test "Tests/4/test10.java" 15)
(test "Tests/4/test11.java" 123456)
(test "Tests/4/test12.java" 12)
(test "Tests/4/test13.java" (- 716))
(test "Tests/4/test21.java" 530)
(test "Tests/4/test22.java" 66)
(test "Tests/4/test23.java" 1026)
(test "Tests/4/test24.java" 2045)
(test "Tests/4/test31.java" 20)
(test "Tests/4/test32.java" 530)
(test "Tests/4/test33.java" 615)
(test "Tests/4/test34.java" 16)
(test "Tests/4/test35.java" 100)
(test "Tests/4/test36.java" 420)
(test "Tests/4/test37.java" `error)
(test "Tests/4/test41.java" 300)
(test "Tests/4/test42.java" `error)
(test "Tests/4/test51.java" 417)
(test "Tests/4/test52.java" 10)
(test "Tests/4/test53.java" 48)
(test "Tests/4/test54.java" 1629)
